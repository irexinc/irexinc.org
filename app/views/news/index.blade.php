...
@section('content')
  ...
  <div class="content-block">
    ...
    <ul>
      ...
      <li>Appliance rebates on high-efficiency appliances</li>
      <li>Online tools and resources to analyze your home or businesses' energy use</li>
      <li>Free and low-cost energy efficiency tips to lower energy usage</li>
      <li>Billing and payment options to manage costs</li>
      <li>Information about the natural gas Choice program (Ohio only)</li>
      <li>Outage response, electric and/or natural gas safety</li>
    </ul>

    <p>Joining Karen will be one of Vectren's business marketing consultants to talk about <a href="http://www.vectren.com/Save_Energy/Business_Rebates_&amp;_Incentives/Business_Rebates.jsp">opportunities in commercial applications for rebates and reducing utility costs</a>.</p>

    <br>

    <p><strong>A little more information about Karen:</strong></p>

    <p><em>In November 2010, Karen Lyles joined the Sales/Marketing department at Vectren Corporation where she is responsible for new business growth and development of Boone, Carroll, Tippecanoe, Clinton, Montgomery, and White counties.  Prior to working for Vectren, the Gary, Indiana, native served as the Vice President of Programs and Administration for the Center for Leadership Development.</em></p>
